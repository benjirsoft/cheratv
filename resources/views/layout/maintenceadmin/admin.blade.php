...
<head>
  ...
  <title>MaintainAdmin Dashboard</title>
        ...
        <li class="nav-item dropdown has-arrow">
          ...
          <div class="dropdown-menu">
            <div class="user-header">
              ...
              <div class="user-text">
                <h6>Jolbihongo</h6>
                <p class="text-muted mb-0">MaintanceAdmin</p>
              </div>
      ...
      <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
          <ul>
            ...
            <li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Content Upload </span> <span class="menu-arrow"></span></a>
              <ul class="submenu_class" style="display: none;">
                <li><a href="{{ route('websitevideoview')}}">Video View</a></li>
                <li><a href="{{ route('categoryinsertform')}}">Category Add</a></li>
                <li><a href="{{ route('taginsertform')}}">SubCategory Add</a></li>
                <li><a href="{{ route('taglist')}}">SubCategory List</a></li>
                <li><a href="#">Category update</a></li>
                <li><a href="{{ route('categorylist')}}">Category View</a></li>
                <li><a href="#">Edit Video </a></li>
                <li><a href="{{ route('addvideoform')}}">Add Video</a></li>
                <li><a href="{{ route('websitecontentview')}}">Website Content Update</a></li>
                <li><a href="{{ route('addwebsitecontenttemplate')}}"> Add Website Content </a></li>
              </ul>
            </li>
            ...
            <li class="submenu"> <a href="#"><i class="fas fa-key"></i> <span>Social Media</span> <span class="menu-arrow"></span></a>
              <ul class="submenu_class" style="display: none;">
                <li><a href="{{ route('addlinkform')}}">Add Link </a></li>
                <li><a href="{{ route('linklist')}}">List Link </a></li>
                <li><a href="{{ route('socialworkstaus')}}">Link Status </a></li>
                <li><a href="{{ route('addsocialworcategoryform')}}">Add Category </a></li>
                <li><a href="{{ route('socialworklist')}}">List Category</a></li>
              </ul>
            </li>
