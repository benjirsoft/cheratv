...
@section('content') 
        <div class="page-header">
          <div class="row align-items-center">
            <div class="col">
              <h5 class="page-title mt-5">Create Subscriber</h5><br>
              <span>Your Purchase Balance = {{ $balance }} BDT</span>
              </div>
          </div>
        </div>
        <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="packages_id" id="sel3" name="sellist1">
                      ...
                      <option value="2">1Year-Free-000 BDT</option>
                    </select>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Mobile No(bKash No)</label>
