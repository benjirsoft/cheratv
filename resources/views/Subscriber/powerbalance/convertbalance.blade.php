...
<div class="content container-fluid">
  <div class="page-header">
    <div class="row align-items-center">
      <div class="col">
        <h5 class="page-title mt-5"><span style="font-size: 18px;">Convert To Purchase Balance</span></h5>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
      ...
      <form action="{{ route('convertpowerbalance')}}" method="POST">
        @csrf
        <div class="row formtype">
          <div class="col-md-4">
            <div class="form-group">
              <label><span style="font-size:13px">Convert Amount</span></label>
                <input class="form-control" name="amount" required type="numeric"><span>Your Current Main Balance = {{ $powerbalance }} BDT</span>
                @error('amount')
